...
- **[Scoop](https://scoop.sh/#/apps?q=ArchiSteamFarm)**, permitindo que você instale facilmente o ASF nas janelas.
...
- **[CS2Script](https://github.com/Citrinate/CS2Script)**, permite que você gerencie suas unidades de armazenamento Counter-Strike 2 com ajuda do plugin **[CS2Interface](https://github.com/Citrinate/CS2Interface)**.
...
Recomendamos o tópico **[ArchiSteamFarm](https://github.com/topics/archisteamfarm)** no GitHub para todos os projetos que integram com o ASF. Tenha em mente, no entanto, que projetos não relacionados ao ASF também podem tentar usar a tag, geralmente para autopromoção. Por isso, sempre é uma boa ideia verificar duas vezes.