...
在本範例中，我們要修改ASF預設的&#8203;`systemd`&#8203;單元的行為，從只在成功退出時重新啟動，改成在致命崩潰時也重新啟動。 為此，我們將會覆寫&#8203;`[Service]`&#8203;下的&#8203;`Restart`&#8203;屬性，從預設的&#8203;`on-success`&#8203;改成&#8203;`always`&#8203;。 只需執行&#8203;`systemctl edit ArchiSteamFarm@asf`&#8203;，將&#8203;`asf`&#8203;取代成您服務實際使用的目標使用者即可。 然後依&#8203;`systemd`&#8203;中的指示，在正確的段落中加入您的改動：
