...
首先，可以透過使用&#8203;`BotBehaviour`&#8203;中的&#8203;`DisableIncomingTradesParsing`&#8203;旗標，來停用&#8203;**所有**&#8203;接收到的交易提案。 Using that, as the name implies, will disable all functionality related to incoming trades parsing, which includes below default logic, as well as all extra features available which depend on reacting to the incoming trade offer. 因為預設已為非侵入性設定，您應僅在ASF不對接收到的交易提案做出任何反應時，才考慮使用本選項。
