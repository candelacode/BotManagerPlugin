...
- **[ASFAchievementManager](https://github.com/CatPoweredPlugins/ASFAchievementManager)**&#8203;：使您能夠透過ASF管理Steam成就。
- **[BirthdayPlugin](https://github.com/CatPoweredPlugins/BirthdayPlugin)**&#8203;：使ASF能夠接收生日祝福。
- **[CaseInsensitiveASF](https://github.com/CatPoweredPlugins/CaseInsensitiveASF)**：使ASF的Bot名稱不區分大小寫。
- **[CommandAliasPlugin](https://github.com/CatPoweredPlugins/CommandAliasPlugin)**：使ASF能夠設定自訂指令別名。
- **[Commandless-Redeem](https://github.com/CatPoweredPlugins/CommandlessRedeem)**&#8203;：使ASF無需指令，即可重新實現序號啟動。
- **[ItemDispenser](https://github.com/CatPoweredPlugins/ItemDispenser)**&#8203;：ASF將會自動接受特定類型物品的交易請求。
- **[Selective-Loot-and-Transfer-Plugin](https://github.com/CatPoweredPlugins/SelectiveLootAndTransferPlugin)**&#8203;：使ASF提供進階的&#8203;`transfer`&#8203;指令來轉移Steam物品。
...
- **[simple-asf-bot](https://github.com/deluxghost/simple-asf-bot)**&#8203;：另一個（最小版本）用Python編寫，整合ASF與Telegram機器人。
...
- **[Scoop](https://scoop.sh/#/apps?q=ArchiSteamFarm)**&#8203;：讓您能輕鬆地在Windows上安裝ASF。
...
- **[CS2Script](https://github.com/Citrinate/CS2Script)**&#8203;，讓您能在&#8203;**[CS2Interface](https://github.com/Citrinate/CS2Interface)**&#8203;外掛程式的協助下管理《絕對武力2》的物品庫。
...
我們建議您在GitHub上搜尋&#8203;**[ArchiSteamFarm](https://github.com/topics/archisteamfarm)**&#8203;主題，來尋找關於ASF的所有專案。 但請注意，無關ASF的專案也可能使用相關的標籤，通常用於提高曝光度，所以最好二次確認一下。