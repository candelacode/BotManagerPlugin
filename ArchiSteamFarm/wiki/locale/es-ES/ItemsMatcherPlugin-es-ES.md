...
Mostramos todas las cuentas de ASF elegibles que estaban activas en los **últimos 15 minutos**. Los usuarios se ordenan de acuerdo a su utilidad relativa - los bots con `MatchEverything` que se muestran con la etiqueta `Any` que aceptan todos los intercambios 1:1, luego por cantidad de juegos únicos, y finalmente por cantidad de artículos.
...
Desde el momento en que dejas de usar (anunciarte) en nuestro listado, tus datos dejarán de estar disponibles para el público en general en un máximo de 15 minutos, y se conserva en nuestro servidor por un máximo de dos semanas - todo es eliminado automáticamente después de ese período. No requieres realizar ninguna acción para eso.
...
En cualquier caso, entendemos que `MatchActively` no es para todos, y esperamos que también entiendas por qué no podemos ofrecerla gratuitamente. Si a nadie le interesara ayudar a cubrir los costos de esta funcionalidad, simplemente no existiría, ya que nos veríamos forzados a recortar gastos mensuales que nadie está dispuesto a cubrir. Afortunadamente, nos encontramos en mejor posición que eso, y puedes decidir si estás dispuesto a usar o no `MatchActively` en esos términos.
