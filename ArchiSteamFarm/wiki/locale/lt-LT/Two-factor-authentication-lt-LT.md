...
- Jei naudojate oficialią programą ir jūs neprieštaraujate iš naujo nustatyti 2FA kredencialus, geriausia išjungti 2FA, tada **[ sukurti ](#creation)** naujus 2FA kredencialus naudojant **[ jungtinį autentifikatorių ](#joint-authenticator)**, kuris leis naudoti oficialią programą ir ASF 2FA. This method **doesn't require root**, jailbreaking or any advanced knowledge, barely following instructions written here, and is arguably superior for this scenario.
