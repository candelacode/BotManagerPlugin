...
Мы делаем все возможное для того, чтобы последовательно придерживаться политики устаревания с целью обеспечения большей согласованности как разработки, так и использования.

---

## Что такое устаревание?

Устаревание - это процесс более мелких или более мелких ошибочных изменений, которые показывают устаревшие ранее используемые параметры, аргументы, функции или варианты использования. Устаревание обычно означает что какая-то вещь была переписана в другую (похожую) форму, и вам следует как можно раньше убедиться что вы используете её правильно. В этом случае это просто перемещение какой-то функциональности в более подходящее место.
