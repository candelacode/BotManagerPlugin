...
Nous faisons de notre mieux pour suivre une politique de dépréciation cohérente afin de rendre à la fois le développement et l'utilisation beaucoup plus cohérente.

---

## Qu'est ce la dépréciation ?

La dépréciation est le processus de modifications plus petites ou plus importantes qui rendent obsolètes les options, les arguments, les fonctionnalités ou les cas d'utilisation précédemment utilisés. Une désapprobation signifie généralement que quelque chose a été simplement réécrit d'une autre manière, et vous devez vous assurer que vous y passerez dans les meilleurs délais. Dans ce cas, il s'agit simplement de déplacer une fonctionnalité  vers un emplacement plus approprié.
