...
- **[Scoop](https://scoop.sh/#/apps?q=ArchiSteamFarm)**，使您能在 Windows 上轻松安装 ASF。
...
- **[CS2Script](https://github.com/Citrinate/CS2Script)**，使您可以在 **[CS2Interface](https://github.com/Citrinate/CS2Interface)** 插件的帮助下管理 Counter-Strike 2 库存。
...
我们建议您在 GitHub 上搜索 **[ArchiSteamFarm](https://github.com/topics/archisteamfarm)** 主题来寻找关于 ASF 的项目。 请注意，一些与 ASF 无关的项目也可能使用此标签，通常是用于自我宣传，所以您总是应该仔细分辨。