...
Unter Tricks bedeutet **eine ernsthafte Speichererhöhung** und sollte daher mit Vorsicht verwendet werden.
...
./ArchiSteamFarm # Für OS-spezifische Build
./ArchiSteamFarm.sh # für generisches Build
```
...
.\ArchiSteamFarm.exe # Für OS-spezifische Build
.\ArchiSteamFarm.cmd # für generisches Build
```
