...
Nếu bạn không chắc về cách đặt thuộc tính này, hãy để nó với giá trị mặc định là `1`.
...
`string` type with default value of `null`. ASF will use this property when logging in to Steam network, which can be used for customization in regards to how exactly Steam will display ASF machine and session, e.g. when displaying devices that are currently logged in **[here](https://store.steampowered.com/account/authorizeddevices)**.
...
| Giá trị | Tên                     | Mô tả                                                                                                                                                                                                                                                             |
| ------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0       | None (Không có)         | No allowed third-party communication, rendering selected ASF features unusable                                                                                                                                                                                    |
