...
- **Bạn cần sở hữu trò chơi trên tài khoản Steam của bạn để có điều kiện cho thẻ bất kỳ nào rớt từ nó. Family sharing is not ownership and doesn't count.**
...
- **Trò chơi trả phí mà bạn đã nhận được miên phí trong khi có khuyến mãi không thể cày để rơi thẻ được, dù bất kể những thứ gì được hiển thị trên trang cửa hàng đi chăng nữa.**
...
Cảm ơn vì bạn đã quan tâm việc này! You can find all details in our **[localization](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Localization)** section.
...
If nothing helps and you have no clue what is broken, you can always enable `Debug` mode and see yourself in ASF log why exactly requests are failing. Một ví dụ là:
